...
const ActivityStatus: React.FC = () => {
   ...
   return (
      <div className="flex flex-row grow flex-wrap items-center text-emerald-50 gap-5">
         <a href="https://discord.com/users/Jodek" target="_blank" className="flex flex-row grow items-center border border-emerald-200 rounded-lg justify-between px-5 pb-1 h-20 font-sans text-xl text-emerald-50 gap-3">
         ...
         <div className="px-5 pb-1 border border-emerald-200 rounded-lg font-sans h-20 items-center flex flex-row grow gap-3">
            <i className="bx bxl-spotify text-4xl"></i>
            <div className="flex-1">
               <p className="text-lg font-semibold">Listening to:</p>
               <p className="text-sm">
